...
func static(device hid.DeviceInfo) {
	for i := 0; i < 4; i++ {
		...
		deviceWrite(*Devs[0], []byte{0xe0, byte(0x30 + i), 0x00, 0xaa, 0xff, 0x00, 0xaa, 0xff,
			0x00, 0xaa, 0xff, 0x00, 0xaa, 0xff, 0x00, 0x00,
			0xff, 0x00, 0xaa, 0xff, 0x00, 0xaa, 0xff, 0x00,
			0x00, 0xff, 0x00, 0xaa, 0xff, 0x00, 0xaa, 0xff,
			0x00, 0xaa, 0xff, 0x00, 0xaa, 0xff, 0x00, 0x00,
			0xff, 0x00, 0xaa, 0xff, 0x00, 0xaa, 0xff, 0x00,
			0x00, 0xff, 0x00, 0xaa, 0xff, 0x00, 0xaa, 0xff,
			0x00, 0xaa, 0xff, 0x00, 0xaa, 0xff, 0x00, 0x00,
	...
	changeMode([]byte{0x00, 0xaa, 0xff, 0x00, 0xaa, 0xff,
		0x00, 0xaa, 0xff, 0x00, 0xaa, 0xff, 0x00, 0x00,
		0xff, 0x00, 0xaa, 0xff, 0x00, 0xaa, 0xff, 0x00,
		0x00, 0xff, 0x00, 0xaa, 0xff, 0x00, 0xaa, 0xff,
		0x00, 0xaa, 0xff, 0x00, 0xaa, 0xff, 0x00, 0x00,
